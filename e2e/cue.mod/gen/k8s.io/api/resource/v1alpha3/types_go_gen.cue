...
#ResourceSliceSpec: {
	...
	// +optional
	// +oneOf=NodeSelection
	allNodes?: bool @go(AllNodes) @protobuf(5,bytes,opt)
...
#Device: {
	...
	// +optional
	// +oneOf=deviceType
	basic?: null | #BasicDevice @go(Basic,*BasicDevice) @protobuf(2,bytes,opt)
}
...
#BasicDevice: {
	...
	//
	// +optional
	attributes?: {[string]: #DeviceAttribute} @go(Attributes,map[QualifiedName]DeviceAttribute) @protobuf(1,bytes,rep)
	...
	//
	// +optional
	capacity?: {[string]: resource.#Quantity} @go(Capacity,map[QualifiedName]resource.Quantity) @protobuf(2,bytes,rep)
}
...
#ResourceClaimSpec: {
	...
	controller?: string @go(Controller) @protobuf(2,bytes,opt)
}
...
#DeviceRequest: {
	...
	// +optional
	// +default=false
	adminAccess?: bool @go(AdminAccess) @protobuf(6,bytes,opt)
}
...
#ResourceClaimStatus: {
	...
	// +optional
	// +featureGate=DRAControlPlaneController
	deallocationRequested?: bool @go(DeallocationRequested) @protobuf(3,bytes,opt)
}
...
#AllocationResult: {
	...
	// +optional
	// +featureGate=DRAControlPlaneController
	controller?: string @go(Controller) @protobuf(4,bytes,opt)
}
...
#DeviceClassSpec: {
	...
	// +optional
	// +featureGate=DRAControlPlaneController
	suitableNodes?: null | v1.#NodeSelector @go(SuitableNodes,*v1.NodeSelector) @protobuf(3,bytes,opt)
}
